    ...
    var FormIcons = function(){
        ...
        me.get = function (){
            ...
            for(var i=0; i < me.data.length; i++){
                result += '<tr><td style="font-weight: 600; font-size: 18px; padding: 20px 0px 5px 0px; border-bottom: 1px dotted #666;">'+me.data[i].category+'</td></tr>';
                result += '<tr><td>';
                for(var j=0; j < me.data[i].items.length; j++){
                    var icon = me.data[i].items[j];
                    result += '<div onclick="formIcons.selected(\''+icon+'\')" style="display: inline-block; width: 250px; padding: 5px 0px">'+
                              '    <i style="font-size: 20px" class="fa fa-fw '+icon+'"></i>'+
        ...
        me.selected = function(icon){
            Ext.getCmp('form-icon-text').setValue(icon);
            me.close();
        }
