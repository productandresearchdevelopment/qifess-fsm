<div class="wo-container">
    ...
    <div class="container info-container">
        <div id="{id}" class="content" style="display: flex; cursor: pointer">   
        ...
        <div class="info">
            <i>(Open: {start_date}, Close: {end_date})</i>
        </div>
        <div style="flex: 1; margin-top: 5px; border-right: 1px solid #eee; text-align: left">
            <span>Site</span>
            {site.name}
        </div>                   
