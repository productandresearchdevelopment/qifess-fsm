...
<p>Kebijakan Privasi berikut ini menjelaskan bagaimana kami mengumpulkan, menyimpan, menggunakan, mengolah, menguasai, mentransfer, mengungkapkan dan melindungi Informasi Pribadi anda. Kebijakan Privasi ini berlaku bagi seluruh pengguna aplikasi-aplikasi, situs web <a href="https://petro1-indonesia.com">https://petro1-indonesia.com</a>, layanan, atau produk (&ldquo;<strong>Aplikasi</strong>&rdquo;) kami, kecuali diatur pada kebijakan privasi yang terpisah.</p>
<p>Mohon baca Kebijakan Privasi ini dengan seksama untuk memastikan bahwa anda memahami bagaimana proses pengolahan data kami. Kecuali didefinisikan lain, semua istilah dengan huruf kapital yang digunakan dalam Kebijakan Privasi ini memiliki arti yang sama dengan yang tercantum dalam Ketentuan Pengunaan.</p>
...
<ol>
    <ol>
        <li><strong>PENGGUNAAN INFORMASI PRIBADI YANG KAMI KUMPULKAN</strong>
            <p>Kami dapat menggunakan Informasi Pribadi yang dikumpulkan untuk tujuan sebagai berikut maupun untuk tujuan lain yang diizinkan oleh peraturan perundang-undangan yang berlaku ("<strong>Tujuan"</strong>):</p>
            <ol style="list-style-type: lower-alpha;">
                <li>Jika anda adalah pengguna, kami dapat menggunakan Informasi Pribadi anda:
                    <ul class="list-disc">
                        ...
                        <li>untuk memelihara, mengembangkan, menguji, meningkatkan, dan mempersonalisasikan Aplikasi untuk memenuhi kebutuhan dan preferensi anda sebagai pengguna;</li>
                ...
                <li>Jika anda adalah penyedia layanan, kami dapat menggunakan Informasi Pribadi anda:
                    <ul class="list-disc">
                        ...
                        <li>untuk memfasilitasi atau memungkinkan verifikasi apapun yang menurut pertimbangan kami mungkin perlu dilakukan sebelum kami dapat mendaftarkan anda sebagai penyedia layanan, termasuk untuk KYC (<em>Know Your Customer</em>) dan penilaian kredit (<em>credit scoring</em>);</li>
                        <li>untuk memungkinkan anda memberikan layanan kepada pengguna;</li>
                        ...
                        <li>untuk memberikan anda pemberitahuan dan pembaruan pada Aplikasi atau perubahan cara penyediaan layanan;</li>
                        ...
                        <li>untuk memproses dan mengelola reward points anda;</li>
                        <li>untuk menawarkan atau menyediakan layanan dari afiliasi atau mitra kami;</li>
                ...
                <li>Baik anda merupakan pengguna ataupun penyedia layanan atau pihak yang memberikan Informasi Pribadi kepada kami, kami juga dapat menggunakan Informasi Pribadi anda secara lebih umum untuk tujuan-tujuan sebagai berikut (walaupun dalam kasus tertentu kami akan bertindak secara wajar dan tidak menggunakan Informasi Pribadi anda lebih dari apa yang diperlukan untuk tujuan tersebut):
                    <ul class="list-disc">
                        ...
                        <li>untuk memberikan bantuan sehubungan dengan dan untuk menyelesaikan kesulitan teknis atau masalah operasional dengan Aplikasi atau layanan;</li>
...
<ol>
    <ol>
        <li><strong>PEMBERIAN INFORMASI PRIBADI YANG KAMI KUMPULKAN</strong>
            <ol type="a">
                <li>Kami dapat mengungkapkan atau membagikan Informasi Pribadi anda dengan afiliasi dan pihak lain untuk tujuan sebagai berikut ini serta untuk tujuan lain yang diizinkan oleh peraturan perundang-undangan yang berlaku:
                    <ul class="list-disc">
                        <li>jika anda adalah pengguna, untuk memungkinkan penyedia layanan, untuk melakukan atau memberikan layanan;</li>
                        <li>jika anda adalah penyedia layanan, untuk memungkinkan pengguna untuk meminta atau menerima layanan dari anda;</li>
                        ...
                        <li>sehubungan dengan segala proses verifikasi kami atau pihak ketiga perlukan sebelum pemberi layanan memberikan layanan kepada anda atau kami mendaftarkan anda sebagai pengguna, termasuk proses KYC (<em>Know Your Customer</em>) dan penentuan kredit (<em>credit scoring</em>);</li>
                        <li>dalam keadaan darurat terkait keselamatan anda (baik anda adalah pengguna atau penyedia layanan) untuk keperluan menangani keadaan darurat tersebut;</li>
                        ...
                        <li>dalam hal kami berbagi Informasi Pribadi dengan afiliasi, kami akan melakukannya dengan maksud agar mereka membantu kami dalam menyediakan Aplikasi, untuk mengoperasikan bisnis kami (termasuk, ketika anda berlangganan milis kami, untuk tujuan pemasaran langsung), atau untuk tujuan pengolahan data atas nama kami. Semua afiliasi kami berkomitmen untuk mengolah Informasi Pribadi yang mereka terima dari kami sesuai dengan Kebijakan Privasi dan peraturan perundang-undangan yang berlaku ini.</li>
                    </ul>
                </li>
                <li>Ketika Informasi Pribadi tidak perlu dikaitkan dengan anda, kami akan melakukan upaya yang wajar untuk menghapus dikaitkannya Informasi Pribadi tersebut dengan anda sebagai individu sebelum mengungkapkan atau berbagi informasi tersebut.</li>
                <li>Kami tidak akan menjual atau menyewakan Informasi Pribadi anda.</li>
                <li>Selain sebagaimana diatur dalam Kebijakan Privasi ini, kami dapat mengungkapkan dan membagikan Informasi Pribadi anda jika kami memberitahu anda dan kami telah memperoleh persetujuan anda untuk pengungkapan atau pembagian tersebut.</li>
            </ol>
        </li>
    </ol>
</ol>
...
<ol>
    <ol>
        <li><strong>PENYIMPANAN INFORMASI PRIBADI</strong>
            <ol style="list-style-type: lower-alpha;">
...
<ol>
    <ol>
        <li><strong>AKSES DAN KOREKSI INFORMASI PRIBADI</strong>
            <ol style="list-style-type: lower-alpha;">
                <li>Tunduk pada peraturan perundang-undangan yang berlaku, anda dapat meminta kepada kami untuk mengakses dan/atau mengoreksi Informasi Pribadi anda yang berada dalam kepemilikan dan penguasaan kami, dengan menghubungi kami di perincian yang disediakan di bawah ini.</li>
                <li>Kami berhak menolak permintaan anda untuk mengakses, atau untuk memperbaiki, sebagian atau semua Informasi Pribadi anda yang kami miliki atau kuasai jika diizinkan atau diperlukan berdasarkan perundang-undangan yang berlaku. Hal ini termasuk dalam keadaan di mana Informasi Pribadi tersebut dapat berisi referensi kepada orang lain atau di mana permintaan untuk akses atau permintaan untuk mengoreksi adalah untuk alasan yang kami anggap tidak relevan, tidak serius, atau menyulitkan.</li>
            </ol>
        </li>
    </ol>
</ol>
...
<ol>
    <ol>
        <li><strong>TEMPAT KAMI MENYIMPAN INFORMASI PRIBADI ANDA</strong>
            <ol style="list-style-type: lower-alpha;">
                <li>Saat anda menggunakan Aplikasi dan layanan kami di negara lain dimana Aplikasi kami dapat diakses (&ldquo;<strong>Negara Tujuan</strong>&rdquo;), kami dapat mentransfer Informasi Pribadi anda dari negara asal (&ldquo;<strong>Negara Asal</strong>&rdquo;) ke Negara Tujuan untuk membuat anda dapat mengakses dan memastikan pengalaman pelanggan yang lancar ketiga Anda menggunakan Aplikasi kami di luar negeri. Dalam hal tersebut, kami akan meminta persetujuan anda untuk mentransfer Data Pribadi anda dari Negara Asal ke Negara Tujuan untuk memastikan kepatuhan atas hukum dan peraturan yang berlaku.</li>
                <li>Informasi Pribadi dari anda yang kami kumpulkan dapat disimpan, ditransfer, atau diolah oleh penyedia layanan pihak ketiga. Kami akan menggunakan semua upaya yang wajar untuk memastikan bahwa semua penyedia layanan pihak ketiga tersebut memberikan tingkat perlindungan yang sebanding dengan komitmen kami berdasarkan Kebijakan Privasi ini.</li>
                <li>Kami akan mematuhi seluruh peraturan dan hukum yang berlaku dan menggunakan seluruh usaha yang terbaik untuk memastikan Afiliasi kami di negara lain dan seluruh pihak ketiga pemberi layanan memberikan tingkat perlindungan yang setara dengan komitmen kami dalam Kebijakan Privasi ini.</li>
            </ol>
        </li>
    </ol>
</ol>
...
<ol>
    <ol>
        <li><strong>KEAMANAN INFORMASI PRIBADI ANDA</strong>
...
<ol>
    <ol>
        <li><strong>PERUBAHAN ATAS KEBIJAKAN PRIVASI INI</strong>
            <p>Kami dapat meninjau dan mengubah Kebijakan Privasi ini atas kebijakan kami sendiri dari waktu ke waktu, untuk memastikan bahwa Kebijakan Privasi ini konsisten dengan perkembangan kami di masa depan, dan/atau perubahan persyaratan hukum atau peraturan. Jika kami memutuskan untuk mengubah Kebijakan Privasi ini, kami akan memberitahu anda tentang perubahan tersebut melalui pemberitahuan umum yang dipublikasikan pada Aplikasi dan/atau situs web, atau sebaliknya ke alamat e-mail anda yang tercantum dalam Akun anda. Anda setuju bahwa anda bertanggung jawab untuk meninjau Kebijakan Privasi ini secara teratur untuk informasi terbaru tentang pengolahan data dan praktik perlindungan data kami, dan bahwa dengan anda terus menggunakan Aplikasi atau situs web kami, berkomunikasi dengan kami, atau mengakses dan menggunakan layanan setelah adanya perubahan apapun terhadap Kebijakan Privasi ini akan dianggap sebagai persetujuan anda terhadap Kebijakan Privasi ini dan segala perubahannya.</p>
        </li>
    </ol>
</ol>
<p>&nbsp;</p>
<ol>
    <ol>
        <li><strong>PENGAKUAN DAN PERSETUJUAN</strong>
            <ol style="list-style-type: lower-alpha;">
                ...
                <li>Dalam keadaan di mana anda memberikan kepada kami Informasi Pribadi yang berkaitan dengan individu lain (seperti Informasi Pribadi yang berkaitan dengan pasangan anda, anggota keluarga, teman, atau pihak lain), anda menyatakan dan menjamin bahwa anda telah memperoleh persetujuan dari individu tersebut untuk, dan dengan ini menyetujui atas nama individu tersebut untuk, pengumpulan, penggunaan, pengungkapan dan pengolahan Informasi Pribadi mereka oleh kami.</li>
...
<ol>
    <ol>
        <li><strong>MATERI PEMASARAN DAN PROMOSI</strong>
            <p>Kami dan mitra kami dapat mengirimkan anda pemasaran langsung, iklan, dan komunikasi promosi melalui aplikasi push-notification, pesan melalui Aplikasi, pos, panggilan telepon, layanan pesan singkat (SMS), dan email (&ldquo;<strong>Materi Pemasaran</strong>&rdquo;) jika anda telah setuju untuk berlangganan milis kami, dan/atau setuju untuk menerima materi pemasaran dan promosi dari kami. Anda dapat memilih untuk tidak menerima komunikasi pemasaran tersebut kapan saja dengan mengklik pilihan &ldquo;berhenti berlangganan&rdquo; yang ada dalam pesan yang bersangkutan, atau menghubungi kami melalui detail kontak yang tercantum di bawah ini. Mohon perhatikan bahwa jika anda memilih untuk keluar, kami masih dapat mengirimi anda pesan-pesan non-promosi, seperti tanda terima atau informasi tentang Akun anda.</p>
        </li>
    </ol>
</ol>
<p>&nbsp;</p>
<ol>
    <ol>
        <li><strong>DATA ANONIM</strong>
            <p>Kami dapat membuat, menggunakan, melisensikan atau mengungkapkan Informasi Pribadi, yang tersedia, dengan catatan, (i) bahwa semua hal yang dapat mengidentifikasi telah dihapus sehingga data, baik sendiri atau dikombinasi dengan data lain yang tersedia, tidak dapat dihubungkan dengan atau dikaitkan dengan atau tidak dapat mengidentifikasi suatu individu, dan (ii) data serupa telah digabungkan sehingga data asli membentuk bagian dari kumpulan data yang lebih besar.</p>
        </li>
    </ol>
</ol>
<p>&nbsp;</p>
<ol>
    <li><strong>PLATFORM PIHAK KETIGA</strong>
        <ol style="list-style-type: lower-alpha;">
            <li>Aplikasi, situs web, dan Materi Pemasaran dapat berisi tautan ke situs web yang dioperasikan oleh pihak ketiga. Kami tidak mengendalikan atau menerima pertanggungjawaban atau tanggung jawab untuk situs web ini dan untuk pengumpulan, penggunaan, pemeliharaan, berbagi, atau pengungkapan data dan informasi oleh pihak ketiga tersebut. Silakan baca syarat dan ketentuan dan kebijakan privasi dari situs web pihak ketiga tersebut untuk mengetahui bagaimana mereka mengumpulkan dan menggunakan Informasi Pribadi anda.</li>
            <li>Saat anda menggunakan Aplikasi kami dan mengaktifkan fitur sidik jari (<em>fingerprint</em>)dan/atau pengenalan wajah (<em>facial recognition</em>) di perangkat seluler anda untuk keperluan autentikasi, harap dicatat bahwa kami tidak menyimpan data biometrik tersebut. Kecuali diberitahukan lain kepada anda, data tersebut tersimpan di perangkat seluler anda dan dapat disimpan oleh pihak ketiga, seperti pembuat perangkat anda. Anda setuju dan mengakui bahwa kami tidak bertanggung jawab atas setiap akses tidak sah atau kerugian apapun atas data biometrik yang tersimpan di perangkat seluler anda.</li>
            <li>Iklan yang terdapat pada Aplikasi, situs web, dan Materi Pemasaran kami berfungsi sebagai tautan ke situs web pengiklan dan dengan demikian segala informasi yang mereka kumpulkan berdasarkan klik anda pada tautan itu akan dikumpulkan dan digunakan oleh pengiklan yang relevan sesuai dengan kebijakan privasi pengiklan tersebut.</li>
        </ol>
    </li>
</ol>
<p>&nbsp;</p>
