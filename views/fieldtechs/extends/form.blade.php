                ...
                items : [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {xtype:'hiddenfield', name: 'attach', fieldLabel: 'Name', allowBlank: true},
                            ...
                            {xtype: 'textareafield', name: 'address', hidden: true, fieldLabel: 'Address', flex: 1, height: 30, allowBlank: true},
                            {
